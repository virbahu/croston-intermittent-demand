...
*Advanced spare parts optimization for enterprise supply chain operations*

---

## 📋 Overview

**Croston Intermittent Demand** addresses a critical challenge in modern supply chain management: spare parts. This implementation combines rigorous academic methodology with production-ready Python code, suitable for both research and enterprise deployment.

Built on the foundational work of **Professor John Croston**, this tool provides supply chain professionals with an analytical framework that transforms raw operational data into actionable optimization decisions. Whether you're managing a single warehouse or a global multi-echelon network, this toolkit scales to your complexity.
...
Supply chain spare parts is a persistent operational challenge that impacts cost, service, and working capital across the enterprise. Organizations that fail to optimize spare parts typically see:
...
```bash
git clone https://github.com/virbahu/croston-intermittent-demand.git
cd croston-intermittent-demand
pip install -r requirements.txt
python croston_intermittent_demand.py
```
...
```python
# Quick start example
from croston_intermittent_demand import *
...
# See docstrings in croston_intermittent_demand.py for full parameter reference
```
...
| | |
|---|---|
| **Based on** | Professor John Croston, Lancaster University |
| **Key Reference** | See academic references for Professor John Croston |
| **Domain** | Spare Parts |
